              ...
              <AnimatePresence>
                {showShareMenu && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, scale: 1 }}
                    exit={{ opacity: 0, scale: 0.9 }}
                    className="absolute bottom-full right-0 mb-2 p-2 bg-gray-800 rounded-lg shadow-lg min-w-[120px] z-50"
                  >
                    <button
                      onClick={handleCommunityShare}
                      className="w-full px-3 py-2 text-left text-gray-300 text-xs hover:bg-gray-700 rounded-lg transition-colors flex items-center gap-2"
                    >
